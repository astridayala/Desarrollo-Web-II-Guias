 ...
 *
 * @param {Object} props
 * @param {number} props.maxRating - numero maximo de estrellas 
 * @param {string} props.color - color de las estrellas (#fcc419)
 * @param {number} props.size - tamanio de estrellas en pixeles (30px)
 * @param {number} props.defaultRating - calificacion final seleccionada
...
export default function StarRating({
    ...
    //estilos del texto de calificacion
    const textStyle = {
        lineHeight: "1",
        margin: "0",
        color,
    ...
    //estado temporal para manejar la calificacion al pasar el mouse
    ...
    function handleRating(rating){
        setRating(rating);
        onSetRating?.(rating); //llama a la funcion de callback si esta definida
    }
 ...
 * @param {number} props.size - tamanio de la estrella en pixeles
 */
